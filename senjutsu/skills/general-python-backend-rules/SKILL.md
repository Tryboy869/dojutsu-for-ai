---
name: general-python-backend-rules
description: "[Applies to: backend/src/**/*.py] Applies general coding style and structure rules for Python code in the backend."
source: "cursor_mdc"
---
