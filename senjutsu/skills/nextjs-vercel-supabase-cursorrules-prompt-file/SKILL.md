...
description: "Apply for nextjs-vercel-supabase-cursorrules-prompt-file. --- description: Defines general project setup and technology stack for the BA Copilot project. globs: src/**/*.*"
source: "cursorrules"
---
