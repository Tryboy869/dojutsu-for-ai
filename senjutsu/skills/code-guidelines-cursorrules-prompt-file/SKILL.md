...
description: "Apply for code-guidelines-cursorrules-prompt-file. --- description: Applies general coding rules across all file types to maintain code quality, consistency, and prevent common errors. globs: **/*.*"
source: "cursorrules"
---
