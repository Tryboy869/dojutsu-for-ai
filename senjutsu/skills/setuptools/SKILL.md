---
name: setuptools
description: "[Applies to: **/*.py] This guide defines best practices for configuring Python packages using setuptools, emphasizing modern, declarative `pyproject.toml` workflows for robust and maintainable projects."
source: "cursor_mdc"
---
