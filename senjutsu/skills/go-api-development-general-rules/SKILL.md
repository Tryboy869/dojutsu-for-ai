---
name: go-api-development-general-rules
description: "[Applies to: /**/*_api.go] General rules for Go API development using the net/http package, focusing on code quality, security, and best practices."
source: "cursor_mdc"
---
