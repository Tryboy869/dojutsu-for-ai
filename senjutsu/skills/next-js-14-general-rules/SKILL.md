---
name: next-js-14-general-rules
description: "[Applies to: **/app/**/*.*] General rules for Next.js 14 development, including using the app directory, server components, and modern TypeScript syntax."
source: "cursor_mdc"
---
