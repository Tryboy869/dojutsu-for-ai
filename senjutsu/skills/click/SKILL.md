---
name: click
description: "[Applies to: **/*.py] This guide outlines definitive best practices for building robust, maintainable, and user-friendly command-line interfaces (CLIs) using the `click` Python library, emphasizing modern patterns and common pitfalls."
source: "cursor_mdc"
---
