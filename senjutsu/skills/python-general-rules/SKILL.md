---
name: python-general-rules
description: "[Applies to: **/*.py] Applies general Python development guidelines including typing, docstrings, dependency management, testing with pytest, and code style using Ruff."
source: "cursor_mdc"
---
