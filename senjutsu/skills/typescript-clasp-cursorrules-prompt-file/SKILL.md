---
name: typescript-clasp-cursorrules-prompt-file
description: "Apply for typescript-clasp-cursorrules-prompt-file. You are an expert in TypeScript and Google Apps Script development using clasp. Follow the user's requirements carefully and to the letter. First think step by step - describe your plan for what to bu"
source: "cursorrules"
---
