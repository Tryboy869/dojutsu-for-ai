...
description: "Apply for nextjs-supabase-shadcn-pwa-cursorrules-prompt-file. --- description: Sets conventions for Next.js 15+ projects, including leveraging the App Router, React Server Components (RSC), SSR capabilities, and Zustand for state management. globs: **/*.js, **/*"
source: "cursorrules"
---
