---
name: via-ir-pipeline-is-very-slow-use-a-separate-profile-to-pre-c
description: "Apply for via-ir-pipeline-is-very-slow-use-a-separate-profile-to-pre-c. You are an expert in Solidity and smart contract security. General Rules - Cut the fluff. Code or detailed explanations only."
source: "cursorrules"
---
