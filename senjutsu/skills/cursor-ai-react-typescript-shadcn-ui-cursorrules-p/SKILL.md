...
description: "Apply for cursor-ai-react-typescript-shadcn-ui-cursorrules-p. --- description: General rules for React and TypeScript projects, focusing on code clarity and best practices. globs: **/*.{ts,tsx,js,jsx}"
source: "cursorrules"
---
