...
description: "[Applies to: src/**/*.*] Enforces best practices for React Native Expo development within the src directory, promoting maintainable and efficient code."
source: "cursor_mdc"
---
