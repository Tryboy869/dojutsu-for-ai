---
name: cheerio
description: "[Applies to: **/*.{js,jsx}] Definitive guidelines for using cheerio effectively in Node.js projects, focusing on robust web scraping, performance, and maintainable code."
source: "cursor_mdc"
---
