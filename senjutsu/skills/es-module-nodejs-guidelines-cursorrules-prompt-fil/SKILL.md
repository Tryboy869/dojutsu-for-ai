...
description: "Apply for es-module-nodejs-guidelines-cursorrules-prompt-fil. --- description: This rule focuses on code style, refactoring suggestions, and leveraging the latest ES and Node.js features for JavaScript, TypeScript, and Python files. globs: *.js, *.jsx, *.ts, *.t"
source: "cursorrules"
---
