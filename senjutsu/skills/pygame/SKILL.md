---
name: pygame
description: "[Applies to: **/*.py] Definitive guide for building modern, performant, and maintainable Pygame applications using `pygame-gui` for UI, focusing on structure, responsive layout, theme-driven styling, and performance best practices."
source: "cursor_mdc"
---
