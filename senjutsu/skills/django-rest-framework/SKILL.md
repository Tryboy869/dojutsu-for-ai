...
description: "[Applies to: **/*.py] Enforces modern, secure, and performant `django-rest-framework` best practices for API development, focusing on maintainability and scalability."
source: "cursor_mdc"
---
